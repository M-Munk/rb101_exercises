...
# elements as the count argument, while the values of each element will
...
# 0, and empty list should be returned.

# create an empty array
# create a place counter = 1
# for each number of count
# add start_num * counter to array
# add 1 to counter
